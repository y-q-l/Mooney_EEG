...
cfg.toi       = -0.75:0.01:0.25;  % or -0.25:0.005:0.75
...
for i=1:4
    ...
    % left side pairs:
    mtxout_L = zeros(60,22,9,101); %  60 pairs; 22 subjects
    cp =0;
    % Part 1:
...
samp=22;
bins=45:75;  % the bins for test, e.g.,45:75, depend on the bins of interest
lb=length(bins);
sample1=data1(:,bins);
sample2=data2(:,bins);
for k=1:repeat
